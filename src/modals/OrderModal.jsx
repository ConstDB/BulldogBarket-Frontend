...
export default function BulkOrderModal({ onClose, listing }) {
  ...
  return (
    ...
    >
      <div
        className="flex w-[420px] min-h-[440px] flex-col bg-white rounded-[10px] py-7 px-6"
      ...
      >
        ...
        <div className="w-[360px] h-20 bg-[#F0FDF4] m-1 rounded-lg p-2 flex">
          ...
          <h2 className="text-[13px] text-[#166534] ">
            ...
            <span>
              {" "}
              Clicking confirm will immediately reserve stocks for you. Please
              ensure you show up to the meetup.{" "}
            </span>
          </h2>
        </div>
        ...
        <div className="flex my-6 justify-between">
          ...
          <h1 className="text-2xl text-[#35408E] font-bold">
            ₱{totalAmount}.00
          </h1>
        </div>
